...
$(eval $(BUILD)/video/barebox/video.mp4: $(BUILD)/bootloaders/barebox.image.qemu $(BUILD)/video/barebox/script.gdb | $(BUILD)/video/barebox/ builder/packages/ffmpeg{} builder/packages/netpbm{} builder/packages/socat{} builder/sysctl/overcommit_memory{} ; $(call video-mp4,$(BUILD)/video/barebox/data,$(BUILD)/video/barebox/script.gdb,$$<,1000))

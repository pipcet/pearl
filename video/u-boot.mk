...
$(eval $(BUILD)/video/u-boot/video.mp4: $(BUILD)/bootloaders/u-boot.image.qemu $(BUILD)/video/u-boot/script.gdb | $(BUILD)/video/u-boot/ $(call done,toolchain/binutils-gdb,install) builder/packages/ffmpeg{} builder/packages/netpbm{} builder/packages/socat{} builder/sysctl/overcommit_memory{} ; $(call video-mp4,$(BUILD)/video/u-boot/data,$(BUILD)/video/u-boot/script.gdb,$$<,1000))

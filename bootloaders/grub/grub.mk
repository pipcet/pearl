$(BUILD)/bootloaders/grub.efi: $(BUILD)/bootloaders/grub/done/install
...
$(BUILD)/bootloaders/grub/done/install: $(BUILD)/bootloaders/grub/done/build | $(BUILD)/bootloaders/grub/done/
	$(WITH_CROSS_PATH) $(MAKE) -C $(BUILD)/bootloaders/grub/build install
	@touch $@

$(BUILD)/bootloaders/grub/done/build: $(BUILD)/bootloaders/grub/done/configure
	$(WITH_CROSS_PATH) $(MAKE) -C $(BUILD)/bootloaders/grub/build
	@touch $@

$(BUILD)/bootloaders/grub/done/configure: $(BUILD)/bootloaders/grub/done/copy $(BUILD)/glibc/done/glibc/install | $(BUILD)/bootloaders/grub/build/
...
$(BUILD)/bootloaders/grub/done/copy: $(BUILD)/bootloaders/grub/done/checkout | $(BUILD)/bootloaders/grub/build/
	$(CP) -aus $(PWD)/bootloaders/grub/grub/* $(BUILD)/bootloaders/grub/build/
	@touch $@

$(BUILD)/bootloaders/grub/done/checkout: | $(BUILD)/bootloaders/grub/done/

build/debootstrap/stage1.tar: | build/debootstrap/
	sudo DEBOOTSTRAP_DIR=$(PWD)/submodule/debootstrap ./submodule/debootstrap/debootstrap --foreign --arch=arm64 --include=dash,wget,busybox,busybox-static,network-manager,openssh-client,net-tools,libpam-systemd,cryptsetup,lvm2,memtool,nvme-cli sid build/debootstrap/stage1 http://deb.debian.org/debian

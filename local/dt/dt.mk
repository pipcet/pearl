...
$(BUILD)/dt/build/bin/adtdump: local/dt/adtdump.c $(call done,toolchain/glibc,glibc/install) | $(BUILD)/dt/build/bin/
	$(WITH_CROSS_PATH) $(CROSS_COMPILE)gcc -Os -static -o $@ $<

$(BUILD)/dt/build/bin/macho-version: local/dt/macho-version.c $(call done,toolchain/glibc,glibc/install) | $(BUILD)/dt/build/bin/
	$(WITH_CROSS_PATH) $(CROSS_COMPILE)gcc -Os -static -o $@ $<

$(BUILD)/dt/build/bin/adtp: local/dt/adtp.cc $(call done,toolchain/glibc,glibc/install)  $(call done,toolchain/gcc,g++/install) | $(BUILD)/dt/build/bin/

...
$(BUILD)/done/cryptsetup/copy: $(BUILD)/done/cryptsetup/checkout | $(BUILD)/done/cryptsetup/ $(BUILD)/cryptsetup/build/
	cp -a userspace/cryptsetup/cryptsetup/* $(BUILD)/cryptsetup/build/
	@touch $@

$(BUILD)/done/cryptsetup/checkout: userspace/cryptsetup/cryptsetup{checkout} | $(BUILD)/done/cryptsetup/
	@touch $@

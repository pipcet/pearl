...
$(BUILD)/gcc/done/stage1/configure: $(BUILD)/gcc/done/stage1/copy $(BUILD)/install/done/mkdir $(BUILD)/binutils-gdb/done/install $(BUILD)/glibc/done/headers/install | $(BUILD)/gcc/stage1/build/

...
$(BUILD)/done/toolchain/gcc/stage1/configure: $(BUILD)/done/toolchain/gcc/stage1/copy $(BUILD)/done/install/mkdir | $(BUILD)/toolchain/gcc/stage1/build/
	(cd $(BUILD)/toolchain/gcc/stage1/build; ../source/configure --target=aarch64-linux-gnu --enable-languages=c --disable-shared --disable-nls --disable-threads --disable-bootstrap --prefix=/ --with-sysroot="$(BUILD)/install" --disable-libgcc --disable-libssp --disable-libquadmath --disable-libatomic --disable-libgomp --without-headers)
	touch $@

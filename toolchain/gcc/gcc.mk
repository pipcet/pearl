...
$(BUILD)/toolchain/gcc/done/gcc/configure: $(BUILD)/toolchain/gcc/done/gcc/copy $(BUILD)/linux/done/headers/install $(BUILD)/glibc/done/headers/install $(BUILD)/binutils-gdb/done/install | $(BUILD)/toolchain/gcc/gcc/build/
...
$(BUILD)/toolchain/gcc/done/libgcc/configure: $(BUILD)/toolchain/gcc/done/libgcc/copy $(BUILD)/linux/done/headers/install $(BUILD)/glibc/done/headers/install $(BUILD)/binutils-gdb/done/install $(BUILD)/glibc/done/glibc/install | $(BUILD)/toolchain/gcc/libgcc/build/

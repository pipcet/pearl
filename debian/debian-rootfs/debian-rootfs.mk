...
$(BUILD)/debian/debian-rootfs/root1.cpio: $(BUILD)/qemu-kernel $(BUILD)/debian/debian-rootfs/root0.cpio | $(BUILD)/ builder/packages/qemu-system-aarch64{} builder/packages/sharutils{} builder/sysctl/overcommit_memory{}
